        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <Link
            ...
            className={cn(
              ...
              "bg-nutri-green-dark text-white font-bold text-sm",
    ...
    >
      ...
      <LegalSection title="2. Information We Collect">
        <div className="grid grid-cols-2 gap-6 my-4">
          <div className="bg-[#f5f3ee] rounded-[32px] p-6">
            <img src={iconAccount} alt="" className="size-5 mb-3" />
            <h4 className="font-bold text-nutri-dark-text mb-2">Account Information</h4>
            <p className="text-[#434939] text-sm leading-relaxed">
          ...
          <div className="bg-[#f5f3ee] rounded-[32px] p-6">
            ...
            <h4 className="font-bold text-nutri-dark-text mb-2">Health Profile Data</h4>
            <p className="text-[#434939] text-sm leading-relaxed">
        ...
        <div className="mt-4">
          <h4 className="font-extrabold text-nutri-green-forest text-lg mb-3">
      ...
      <LegalSection title="4. Legal Basis">
        <p className="text-nutri-dark-body text-sm italic mb-3 opacity-70">
          (EEA / UK Users Only)
        </p>
        <LegalParagraph>
      ...
      {/* 5 — Figma: Section displayed on light bg with pill tags */}
      <LegalSection title="5. How We Share Your Information">
        ...
        <div className="flex flex-wrap gap-3 mt-4">
          {["Service Providers", "Legal Requirements", "Business Transfers", "Explicit Consent"].map((tag) => (
            <span
              key={tag}
              className="bg-white text-nutri-dark-text font-black text-[10.4px] px-4 py-2 rounded-full border border-[rgba(195,201,180,0.3)] uppercase tracking-[0.52px]"
            >
              {tag}
            </span>
          ))}
      ...
      {/* 6 & 7 — Figma layout: side by side with correct colors */}
      <div className="grid grid-cols-2 gap-12 py-14">
        {/* Section 6: Data Retention — Figma: label in #434939 (medium), value in #416600 (bold) with bottom border */}
        <div className="flex flex-col gap-6">
          <h2 className="font-extrabold text-nutri-green-forest text-[32px]">
            6. Data Retention
          </h2>
          <div className="flex flex-col gap-4">
            {[
              ...
              >
                <span className="text-[#434939] font-medium text-base">{item.label}</span>
                <span className="text-[#416600] font-bold text-base">{item.value}</span>
              </div>
            ))}
          </div>
        </div>

        {/* Section 7: Data Security — Figma: black (#1b1c19) card with green accent text */}
        <div className="flex flex-col gap-6">
          <h2 className="font-extrabold text-nutri-green-forest text-[32px]">
            7. Data Security
          </h2>
          <div className="bg-[#1b1c19] rounded-[32px] p-6 flex items-center gap-6">
            <img src={iconLock} alt="" className="w-8 h-10 shrink-0" />
            <div className="flex flex-col gap-[23px] pb-6">
              <p className="text-[#bef458] font-medium text-sm">TLS 1.2+ Encryption</p>
              <p className="text-[#d1d5db] font-medium text-sm">AES-256 at Rest</p>
              <p className="text-[#d1d5db] font-medium text-sm">Strict Access Controls</p>
            </div>
          </div>
        </div>
      </div>

      {/* 8 — Figma layout: 3×2 grid of rounded-16px cards, centered text */}
      <LegalSection title="8. Your Rights and Choices">
        <div className="grid grid-cols-3 gap-4">
          {["Access", "Correction", "Deletion", "Portability", "Opt-out", "Restriction"].map((right) => (
            <div
              key={right}
              className="bg-[#f0eee9] rounded-2xl p-4 flex items-center justify-center"
            >
              <span className="font-bold text-nutri-dark-text text-sm text-center">
                {right}
              </span>
            </div>
          ))}
        </div>
        <p className="text-nutri-dark-text text-base mt-4 text-center font-medium">
      ...
      {/* Questions — Figma: compact card with icon + inline text */}
      <div className="bg-[#f5f3ee] rounded-[32px] p-6 flex items-center gap-4">
        <img src={iconMail} alt="" className="w-[25px] h-5 shrink-0" />
        <div className="flex flex-col gap-6">
          <p className="font-bold text-nutri-dark-text text-base">Questions?</p>
          <a
            href="mailto:privacy@odysseynutrition.com"
            className="text-[#416600] font-medium text-base hover:underline"
          >
            privacy@odysseynutrition.com
          </a>
        </div>
